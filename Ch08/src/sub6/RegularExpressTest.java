...
public class RegularExpressTest {
	public static void main(String[] args) {
		...
		String [] Patterns = {".",		//문자 1개
							...
							"^[0-9]",	//시작문자^ 가 숫자여야 한다. 숫자로 시작하는 문자
							"[^0-9]",	//not 숫자가 아닌 문자
							"[a-z]*",	//소문자 0개 이상
							"[A-Z]+",	//대문자 1개 이상
							"[ㄱ-힣]+",	//한글 1자 이상
		...
		String p1 = "^[0-9]*$";			//$는 종결, 숫자로 시작하는 문자열
		String p2 = "^[a-zA-Z]*$";		//영어 소대문자로 시작하는 문자열
		String p3 = "^[가-힣]*$";
		String p4 = "^[a-zA-Z0-9]*$";
		String p5 = "(01\\d{1})-(\\d{3,4})-(\\d{4})";		//휴대폰 번호
		String p6 = "(\\w+)@(\\w+).(\\w+)";								//이메일

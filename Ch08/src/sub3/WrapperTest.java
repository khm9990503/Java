...
public class WrapperTest {
	public static void main(String[] args) {
		...
		//wrapper 클래스로 포장
		Integer w1 = new Integer(var1);		// 예전에는 사용했지만 향후 사용하지 않기
		...
		//wrapper 기능 : Wrapper -> 기본타입 (Auto-UnBoxing)
		int 	v1 = wr1;
		double 	v2 = wr2;
		boolean v3 = wr3;
		...
		//wrapper 기능 :  기본타입 -> Wrapper (Auto-Boxing)
		Integer wp1 = v1;
		Double wp2 = v2;
		Boolean wp3 = v3;

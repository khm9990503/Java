...
public class MapTest {
	...
	public static void main(String[] args) {
		...
		apple.show();
		mapList.get(0).get(101).show(); // 한줄로
		//호주사과
		Map<Integer,Apple> h = mapList.get(1);
		Apple Happle = h.get(203);
		Happle.show();
		mapList.get(1).get(203).show(); // 한줄로
		//대만사과
		Map<Integer,Apple> d = mapList.get(2);
		Apple Dapple = d.get(302);
		Dapple.show();
		mapList.get(2).get(302).show(); // 한줄로
